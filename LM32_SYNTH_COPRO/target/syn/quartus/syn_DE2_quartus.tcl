...
## LM32 system files
    ...
    set_global_assignment -name SEARCH_PATH $TOP_DIR/src/soc_top
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/wb_uart/uart.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/wb_uart/wb_uart.v
    set_global_assignment -name SYSTEMVERILOG_FILE  $TOP_DIR/src/wb_conbus/wb_conbus_arb.sv
    set_global_assignment -name SYSTEMVERILOG_FILE  $TOP_DIR/src/wb_conbus/wb_conbus_top.sv
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_adder.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_addsub.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_cpu.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_dcache.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_decoder.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_icache.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_instruction_unit.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_interrupt.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_load_store_unit.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_logic_op.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_mc_arithmetic.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_monitor.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_multiplier.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_ram.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_shifter.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/lm32_top/lm32_top.v
    set_global_assignment -name VERILOG_FILE  $TOP_DIR/src/wb_timer/wb_timer.v
    set_global_assignment -name SYSTEMVERILOG_FILE  $TOP_DIR/src/wb_bram/wb_bram.sv
    set_global_assignment -name SYSTEMVERILOG_FILE  $TOP_DIR/src/soc_top/system.sv
    set_global_assignment -name SYSTEMVERILOG_FILE  $TOP_DIR/src/wb_sram/wb_sram16.sv
